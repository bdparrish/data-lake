...
type Config struct {
	...
	AwsIngestBucketName        string `mapstructure:"AWS_INGEST_BUCKET_NAME"`
	AwsCatalogBucketName       string `mapstructure:"AWS_CATALOG_BUCKET_NAME"`
...
func bindValues(v *viper.Viper) {
	...
	_ = v.BindEnv("AWS_INGEST_BUCKET_NAME")
	_ = v.BindEnv("AWS_CATALOG_BUCKET_NAME")
...
func setDefaultValues(v *viper.Viper) {
	...
	v.SetDefault("AWS_INGEST_BUCKET_NAME", "ingest-bucket")
	v.SetDefault("AWS_CATALOG_BUCKET_NAME", "catalog-bucket")
